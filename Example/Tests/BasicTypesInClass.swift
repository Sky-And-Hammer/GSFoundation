...
class BasicTypesInClass: GSJSONType {
    var bool: Bool = true
    ...
    enum EnumInt: Int, GSJSONEnumType {
        case Default
        case Another
    }
    ...
    enum EnumDouble: Double, GSJSONEnumType {
        case Default
        case Another
    }
    ...
    enum EnumFloat: Float, GSJSONEnumType {
        case Default
        case Another
    }
    ...
    enum EnumString: String, GSJSONEnumType {
...
class TestCollectionOfPrimitives: GSJSONType {
