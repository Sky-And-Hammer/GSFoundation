...
class CustomMappingTest: XCTestCase {
    ...
    func testStructMapping() {
        ...
        let a = CustomMappingStruct.from(JSON: jsonString)!
    ...
    func testMultipleNamesMapToOneProperty() {
        ...
        var a = KeyArrayMappingClass.from(JSON: jsonString)!
        ...
        a = KeyArrayMappingClass.from(JSON: jsonString)!
        XCTAssert(a.var1 == "var1_value")
        XCTAssert(a.var2 == "var2_value")
    ...
    func testClassMapping() {
        ...
        let a = CustomMappingClass.from(JSON: jsonString)!
        XCTAssert(a.name == "Bob")
        XCTAssert(a.id == "json_12345")
        XCTAssert(a.height == 180)
    }
    ...
    func testExlucdePropertyForClass() {
        ...
        let a = ExcludedMappingTestClass.from(JSON: jsonString)!
    ...
    func testExcludedPropertyForStruct() {
        ...
        let a = ExcludedMappingTestStruct.from(JSON: jsonString)!
        XCTAssert(a.name == nil)
        XCTAssert(a.id == "12345")
        XCTAssert(a.height == 180)
    }
    ...
    func testCustomTransformableType() {
        ...
        let object = EnumTestType.from(JSON: jsonString)!
    ...
    func testSpecifyPropertyPathMapping() {
        ...
        let mappedObject1 = FlatLayerModel.from(JSON: dict)!
        ...
        let mappedObject2 = FlatLayerModel.from(JSON: jsonString)!
    ...
    func testMappingDeepPathPropModelFromJSON() {
        ...
        let mappedObject = DeepPathPropModel.from(JSON: jsonString)!
