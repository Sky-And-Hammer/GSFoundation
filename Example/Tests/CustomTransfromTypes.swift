...
extension PureEnum: GSJSONCustomTransformable {
...
struct EnumTestType: GSJSONType {
    var aStr: String?
    var aEnum: PureEnum?
}

struct CustomMappingStruct: GSJSONType {
    var name: String?
    var id: String?
    var height: Int?
...
class CustomMappingClass: GSJSONType {
    var name: String?
    var id: String?
    var height: Int?
...
class KeyArrayMappingClass: GSJSONType {
    var var1: String?
    var var2: String?
    var var3: String?
...
class ExcludedMappingTestClass: GSJSONType {
...
struct ExcludedMappingTestStruct: GSJSONType {
    var name: String?
    var id: String?
    var height: Int?
    var notHandyJSONProperty: NotHandyJSON?
...
class FlatLayerModel: GSJSONType {
...
class DeepPathPropModel: GSJSONType {
    var enumMemberOptional: StringEnum?
