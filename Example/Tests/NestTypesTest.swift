...
class NestTypesTest: XCTestCase {
    ...
    func testMappingNestTypesFromJSON() {
        let mappedObject = TopMostLayerModel.from(JSON: jsonString)!
    ...
    func testMappingNestTypesFromNSDictionary() {
        ...
        let mappedObject = TopMostLayerModel.from(JSON: dictionary)!
    ...
    func testMappingNestTypesFromPureDictionary() {
        ...
        let mappedObject = TopMostLayerModel.from(JSON: topmostDict)!
    ...
    func testMappingNestTypesToAndFromDict() {
        ...
        let mappedObject = TopMostLayerModel.from(JSON: dict)!
